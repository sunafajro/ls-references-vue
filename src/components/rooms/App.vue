  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
      ...
      <div v-if="actions.create">
        ...
        <modal-component v-bind:offices="offices" v-on:refresh="getData"/>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
      <breadcrumbs-component type="rooms" v-if="mode === 'bitrix'"/>
      <table-component
  ...
  methods: {
    ...
    async handleDelete(id) {
      try {
        ...
        await this.getData();
        this.$store.dispatch('showNotification', {
          text: res.text ? res.text : 'Кабинет успешно удален!',
          type: 'success',
        });
      } catch (e) {
        this.$store.dispatch('showNotification', {
          text:
            'Не удалось удалить кабинет! ' + (e && e.message ? e.message : ''),
          type: 'error',
        });
      }
    },
