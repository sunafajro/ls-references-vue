<template>
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
      ...
      <info-component/>
      <menu-component title="Справочники"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
      <breadcrumbs-component type="cities" v-if="mode === 'bitrix'"/>
      <table-component
  ...
  methods: {
    ...
    async handleDelete(id) {
      try {
        ...
        const { data: res } = await axios.post("/city/delete?id=" + id, token);
        await this.getData();
        this.$store.dispatch("showNotification", {
          text: res.text ? res.text : "Город успешно удален!",
          type: "success"
        });
      } catch (e) {
        this.$store.dispatch("showNotification", {
          text:
            "Не удалось удалить город! " + (e && e.message ? e.message : ""),
          type: "error"
        });
      }
    },
